...
function App() {
  ...
  useEffect(() => {
    // Only load mock data on very first load when app starts
    if (isFirstLoad && medications.length === 0) {
      ...
      // Don't load mock reminders - they will be auto-generated by the recurring reminder service
      setUserProfile(mockUserProfile);
      setIsFirstLoad(false);
    } else if (!isFirstLoad && medications.length === 0) {
      // User intentionally deleted all medications - don't reload mock data
      console.log('🗑️ All medications deleted - not reloading mock data');
    } else if (medications.length > 0) {
      // We have medications, mark first load as done
      setIsFirstLoad(false);
    }
  }, [isFirstLoad]); // Only depend on isFirstLoad, not medications.length
